  ...
  render() {
    ...
    return (
      <form onSubmit={handleSubmit} className={`${className} payment-form`}>
        ...
        <div className="payment-form__shipping-info">
          <div className="payment-form__shipping-info shipping-info">
            <UnderlineTitle className='shipping-info__title' title='Shipping To' />
            <div className="shipping-info__name small-text">Estelo Abellanosa</div>
            <div className="shipping-info__address small-text">39238 address goes here</div>
          </div>
        </div>
      </form>
    )
